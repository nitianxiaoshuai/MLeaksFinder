...
#                       DESC
  ...
  s.homepage = "https://github.com/nitianxiaoshuai/MLeaksFinder"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "逆天小帅" => "296722587@qq.com" }
  s.source           = { :git => "https://github.com/nitianxiaoshuai/MLeaksFinder.git", :tag => s.version }
